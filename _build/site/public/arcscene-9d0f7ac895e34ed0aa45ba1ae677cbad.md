...
Digital terrain data is often better visualized three dimensionally. In ArcGIS Pro, ArcScene provides a user interface to model digital elevation models and derivatives in 3D. 

```{note}
QGIS offers similar functionality in 3D Map Views.
```
