...
```{image} /images/outputcoord.jpg
:alt: Output Coordinate System
:class: bg-primary mb-1
:width: 80%
:align: center
```

ArcGIS Pro has an abundance of available coordinate systems, but you usually only need to use a handful of them. The search function allows you to find a specific coordinate system, but you have to use the exact spelling to find a match. So instead, I recommend navigating through the menus to find the appropriate coordinate system. Once you have used several coordinate systems, they will appear as Favorites and will be easier to find.

The coordinate systems are divided into Geographic Coordinate System and Projected Coordinate System folders: Here are some commonly-used coordinate systems:

* Geographic Coordinate System -> World -> WGS 1984
* Geographic Coordinate System -> North America -> United States -> NAD 1983 (2011)
* Geographic Coordinate System -> North America -> United States -> NAD 1983
* Geographic Coordinate System -> North America -> Canada -> NAD 1983
* Geographic Coordinate System -> North America -> Mexico ITRF2008

* Projected Coordinate System -> World -> Zone Series -> UTM (WGS 1984) -> Northern Hemisphere -> WGS 1984 UTM zone 17N
* Projected Coordinate System -> North America -> United States -> Florida -> NAD 1983 (2011) StatePlane Florida North FIPS 0903 (US Feet)
* Projected Coordinate System -> World -> WGS 1984 Web Mercator (auxiliary sphere)
* Projected Coordinate System -> North America -> United States -> NAD 1983 (2011) Contiguous USA Albers
* Projected Coordinate System -> North America -> Mexico -> ITRF2008 UTM zone 15N

Vertical coordinate systems are divided into Ellipsoidal and Gravity (geoid) models, for example:
